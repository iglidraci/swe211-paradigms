...
/**
 * Diamond problem
 * Classes B and C are both derived from class A, and class D is derived by
 * multiple inheritance from both B and C.
 * Trouble starts if you try to access a member function in class A from an object of class D
 * Both B and C contain a copy of func(), inherited from A.
